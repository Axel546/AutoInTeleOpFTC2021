 ...
 */
@TeleOp(name = "OrientationAuto", group = "advanced")
public class AutoOrientationDrive extends LinearOpMode {
    enum Mode {
        DRIVER_CONTROL,
        AUTOMATIC_CONTROL
    }
    ...
    Vector2d towerVector = new Vector2d(120,-6);
    ...
    public void runOpMode() throws InterruptedException, FileNotFoundException {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            telemetry.addData("distanceToTower",distanceToTower);
            telemetry.addData("perpendicularDistance",towerVector.getX()-poseEstimate.getX());
            telemetry.update();
