...
import org.firstinspires.ftc.teamcode.rr_quickstart_examples.drive.SampleMecanumDriveCancelable;
 ...
 */
@TeleOp(name = "TrajectoriesInTele", group = "advanced")
public class TrajectoriesInTele extends LinearOpMode {
    ...
    @Override
    public void runOpMode() throws InterruptedException, FileNotFoundException {
        ...
        {
            allCoordinates.add(new Pose2d(scanner.nextInt(),scanner.nextInt(),scanner.nextInt()));
        }
