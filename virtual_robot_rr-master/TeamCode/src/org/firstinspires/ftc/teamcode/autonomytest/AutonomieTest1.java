...
@Autonomous(name = "AutonomieTest1", group = "autonomytest")
public class AutonomieTest1 extends OpMode {
        ...
        switch (state) {
            ...
            case PAUSE:
                if ((clock.seconds() - startPause) > 2.0) {
                    state = State.AWAY1;
                    traj = new TrajectoryBuilder(new Pose2d(63, 20, 0), bot.constraints)
            ...
            case PAUSE1:
                if ((clock.seconds() - startPause) > 2.0) {
                    state = State.AWAY2;
                    traj = new TrajectoryBuilder(new Pose2d(63, -22.5, 0), bot.constraints)
